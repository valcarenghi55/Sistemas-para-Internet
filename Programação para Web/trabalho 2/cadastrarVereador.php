...
<body>
    ...
    <div class="container">
            ...
            <form name = "form" method="post" action="controleVereador.php">
                ...
                <div class="form-floating mb-3">                   
                    <input type="text" class="form-control" id="partido" name = "partido" required placeholder = "">
                ...
                <button type="submit" name="opcao" value="cadastrar" class="btn" >Cadastrar</button>
